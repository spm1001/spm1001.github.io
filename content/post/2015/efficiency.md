---
title: "AMP, efficiency and openness"
date: "2015-10-13"
categories: [AMP]
description:
...
[As usual on this blog views are my own and not any current or previous employer's. Quite pleased looking back at this though - a pretty early pov on AMP and the risks alongside the efficiencies.]{.aside}
...
## Is AMP 'open'?
[Can't help thinking of Rubin's disingenuous tweet about how 'open' Android was. Obviously he's done worse since things since then, but the smugness and deceit of [that tweet](https://techcrunch.com/2010/10/19/andy-rubin-twitter) still sticks in my craw]{.aside}

...
![Google Ads campaign objective selection screen](google-ads-shop.png)
...
![UK media spend is no longer JIC measured - chart showing decline from 95% in 2002 to 16% in 2024](jic-spend-chart.png)
...
![2027: outcomes will dominate video too - chart showing BARB share declining to 55%](outcomes-dominate-video.png)
...
![Ethan Mollick's otter evolution showing AI image generation improving from 2022 to 2024](otters.png)
...
![Exposure and outcome data triangle diagram](triangle.png)
...
![Hybrid Outcome Model - combining large-scale TV exposure, behavioural panel, and advertiser data](hybrid-model.png)
...
![How to hit a moving target - chart showing different model architectures and their learning capacity](learning-curves.png)
...
![A Better FTVA in 5 Steps](five-steps.png)
